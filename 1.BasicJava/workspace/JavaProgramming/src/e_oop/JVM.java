...
public class JVM {
	...
	public static void main(String[] args) {
		...
		jvm.instanceMethod();
		//12. instanceMethod()가 호출되어 CallStack에 저장
		//13. instanceMethod()의 내용을 실행 후, 종료되어 CallStack에서 삭제됨
		
		jvm = null;
		//14. jvm변수에 null이 저장됨
		//15. 어디에서도 주소를 참조하지 않는 JVM객체는 GarageCollector에 의해 삭제됨
